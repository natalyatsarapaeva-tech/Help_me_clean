...
- surfaces — ТОЧКИ комнаты, которые убирают по отдельности: стол, полка, кровать, тумбочка, раковина, пол.
  Сначала выпиши те, что НАЗВАНЫ в тексте, — дословно, как их назвал человек («стол у окна»).
  Не названы — предложи 2–4 типичных для этого типа комнаты.
  Каждая — короткое название в единственном числе, с большой буквы, до 24 символов.
- typical_clutter — 2–4 типичных для этого типа комнаты (для подсказок сканера).
