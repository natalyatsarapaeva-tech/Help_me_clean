...
const CACHE = 'tidy-v6';
const ASSETS = [
  './', './index.html', './home.html', './children.html', './scan.html', './reference.html', './cards.html', './collection.html',
  './styles.css', './pwa.js', './manifest.json',
  './js/firebase.js', './js/store.js', './js/family-core.js',
  './js/child-auth.js', './js/image.js', './js/ai.js', './js/round-core.js', './js/camera.js', './js/cards-core.js',
